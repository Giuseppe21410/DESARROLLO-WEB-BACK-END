...
try{
    ...
    $pdo->exec("SET FOREIGN_KEY_CHECKS = 0"); // Debemos desactivar temporalmente las restricciones de las claves foráneas para poder eleiminar las tablas si existen.
    // Eliminar tablas si existen en el orden adecuado por relaciones foráneas
    $tablasEliminar = [ 
    ...
    foreach ($tablasEliminar as $drop) {
         try {
            $pdo->exec($drop);
