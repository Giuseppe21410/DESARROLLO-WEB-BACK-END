        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary min-vh-100" style="width: 280px;">
            <div href="#" class="d-flex align-items-center">
             ...
             <ul class="nav nav-pills flex-column mb-auto"> 
                <li class="nav-item"> 
                    <a id="enlace_1" href="home" class="nav-link active" aria-current="page"> 
                        <i class="bi bi-house me-2"  aria-hidden="true"></i> 
                        Inicio
                    </a>
                </li> 
                <li> 
                    <a id="enlace_2" href="material_composicion" class="nav-link link-body-emphasis"> 
                        <i class="bi bi-globe"></i>
                        Materiales/Composición
                    </a> 
                </li> 
                <li> 
                    <a id="enlace_3" href="#" class="nav-link link-body-emphasis"> 
                        <i class="bi bi-clipboard"></i>
                        Tareas
                    </a> 
                </li> 
                <li> 
                    <a id="enlace_5" href="/trabajadores" class="nav-link link-body-emphasis"> 
                        <i class="bi bi-people"></i>
                        Trabajadores
                    </a> 
                </li> 
                <li> 
                    <a id="enlace_6" href="#" class="nav-link link-body-emphasis"> 
