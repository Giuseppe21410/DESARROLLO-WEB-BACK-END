...
if (isset($_GET['actualizar_mensajes']) && isset($_SESSION['json_asociado'])) {
    // Construye la ruta al archivo de mensajes, apuntando a la carpeta específica de ANECDOTAS.
    $ruta_json = '../../ASSETS/JSON_MENSAJES/ANECDOTAS/' . $_SESSION['json_asociado'];
...
if (isset($_POST['eliminar_hilo'])) {
    ...
    // Ruta al archivo de mensajes del hilo a eliminar, en la carpeta ANECDOTAS.
...
if (isset($_POST['enviar'])) {
    ...
    // Ruta al archivo de mensajes del hilo actual, en la carpeta ANECDOTAS.
    $ruta_json = '../../ASSETS/JSON_MENSAJES/ANECDOTAS/' . $_SESSION['json_asociado'];
    ...
    if ($error == '') {
        ...
        header('Location: foro_anecdotas.php');
        exit();
    }
}
?>
...
<head>
    ...
    <title>Foro de Anécdotas - ForoConecta</title>
    ...
    <div class="page_container">
        <main>
            <div class="main_container_foro">
                <!-- Encabezado específico del Foro de Anécdotas -->
                <div class="main_container_foro_6">
                    <div class="main_container_4">
                        <p> <i>Anécdotas</i></p>
                        <div class="barra"></div>
                        <p class="p_1">Comparte tus historias más memorables.</p>
                    </div>
                    ...
                    <div class="main_foro_container_1">
                        ...
                        <div class="main_foro_container_hilos_1">
                            ...
                            if (file_exists($ruta_json)) {
                                ...
                                if (is_array($hilos)) {
                                    // Bucle que muestra solo los hilos cuyo campo 'foro' es 'anecdotas'.
