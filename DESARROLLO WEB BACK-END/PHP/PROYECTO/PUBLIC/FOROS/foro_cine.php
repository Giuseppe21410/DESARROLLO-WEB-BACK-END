...
if (isset($_GET['actualizar_mensajes']) && isset($_SESSION['json_asociado'])) {
    // Construye la ruta al archivo de mensajes del hilo seleccionado, específicamente en la carpeta de CINE.
    $ruta_json = '../../ASSETS/JSON_MENSAJES/CINE/' . $_SESSION['json_asociado'];
...
if (isset($_POST['eliminar_hilo'])) {
    ...
    // Ruta al archivo de mensajes del hilo a eliminar, en la carpeta CINE.
    $ruta_mensajes = '../../ASSETS/JSON_MENSAJES/CINE/' . $_SESSION['json_asociado'];

    // Filtra el array de hilos, conservando solo los que NO coinciden con el hilo a eliminar.
...
if (isset($_POST['enviar'])) {
    ...
    // Ruta al archivo de mensajes del hilo actual, en la carpeta CINE.
    $ruta_json = '../../ASSETS/JSON_MENSAJES/CINE/' . $_SESSION['json_asociado'];
...
<head>
    ...
    <title>Foro de Cine - ForoConecta</title>
    ...
    <div class="page_container">
        <main>
            <div class="main_container_foro">
                <!-- Encabezado específico del Foro de Cine -->
                    ...
                    <div class="main_foro_container_1">
                        ...
                        <div class="main_foro_container_hilos_1">
                            ...
                            if (file_exists($ruta_json)) {
                                ...
                                if (is_array($hilos)) {
                                    // Bucle que muestra solo los hilos cuyo campo 'foro' es 'cine'.
