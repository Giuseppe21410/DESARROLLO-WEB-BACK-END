...
if (isset($_GET['actualizar_mensajes']) && isset($_SESSION['json_asociado'])) {
    // Construye la ruta al archivo de mensajes, apuntando a la carpeta específica de OPOSICIONES.
    ...
    if (file_exists($ruta_json)) {
        ...
        // Si el archivo no se encuentra, devuelve un código de error 404 (No encontrado).
...
if (isset($_POST['eliminar_hilo'])) {
    ...
    // Ruta al archivo de mensajes del hilo a eliminar, en la carpeta OPOSICIONES.
    $ruta_mensajes = '../../ASSETS/JSON_MENSAJES/OPOSICIONES/' . $_SESSION['json_asociado'];
...
if (isset($_POST['enviar'])) {
    ...
    // Ruta al archivo de mensajes del hilo actual, en la carpeta OPOSICIONES.
    $ruta_json = '../../ASSETS/JSON_MENSAJES/OPOSICIONES/' . $_SESSION['json_asociado'];
    ...
    if ($error == '') {
        ...
        header('Location: foro_oposiciones.php');
        exit();
    }
}
?>
...
<head>
    ...
    <title>Foro de Oposiciones - ForoConecta</title>
    ...
    <div class="page_container">
        <main>
            <div class="main_container_foro">
                <!-- Encabezado específico del Foro de Oposiciones -->
                    ...
                    <div class="main_foro_container_1">
                        ...
                        <div class="main_foro_container_hilos_1">
                            ...
                            if (file_exists($ruta_json)) {
                                ...
                                if (is_array($hilos)) {
                                    // Bucle que muestra solo los hilos cuyo campo 'foro' es 'oposiciones'.
